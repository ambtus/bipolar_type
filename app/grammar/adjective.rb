class Adjective < Word
  ...
  EXCEPTIONS = %w{appreciate sure unsure responsible constructive expensive predictable probable sore obstinate tactile overtime visible tangible audible future repetitive}
