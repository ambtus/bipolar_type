class Realm < Indexable
  ...
  def potential; choose Noun, %w{weight memories friends savings}; end

  def empty; choose Adjective, %w{hungry afraid lonely poor}; end
  def ill; Phrase.new [adverb, "overwhelmed"]; end
  def full; choose Adjective, %w{restless confident loved rich}; end

  def worn_out; choose Adjective, %w{sore wrong  misunderstood indebted }; end

  def produce; choose Verb, %w{walk think talk buy}; end
