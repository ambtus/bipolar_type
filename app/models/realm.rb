class Realm < Indexable
  ...
  def generic; choose Adjective, %w{ physical mental social financial}; end
  ...
  def shut_down; Phrase.new [stop, the, stimulation] ; end
  ...
  def energy; choose Noun, %w{food colors intonation rewards}; end
  ...
  def bad; choose Adjective, %w{bitter ugly whiny dangerous }; end
  def good; choose Adjective, %w{sweet symmetric harmonious easy}; end
  def obvious; choose Adjective, %w{fragrant bright loud rough}; end
  def subtle; choose Adjective, %w{bland pastel soft smooth}; end
