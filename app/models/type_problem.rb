class TypeProblem
  ...
  def chronic_mania_behaviors; behavior_problems[0,2]; end
  def acute_mania_behaviors; [behavior_problems.first, behavior_problems.third]; end
  def chronic_depression_behaviors; [behavior_problems.second, behavior_problems.fourth]; end
  def acute_depression_behaviors; behavior_problems[2,2]; end
