...
Given I have changed the word for BFE to xyzzy
When I am on my page
Then I should have a bookmark link including 'BFE=xyzzy'

Scenario: sets the cookies
Given I use a bookmark link to my page including 'BFE=xyzzy'
Then I should be on my page
  And I should see xyzzy

Scenario: removes old words
Given I have changed the word for BFE to xyzzy
When I use a bookmark link to my page including 'BFE=plugh'
Then I should be on my page
...
Then I should be on my page
  And I should see plugh
  But I should NOT see xyzzy
  And I should NOT see the default word for BFE
